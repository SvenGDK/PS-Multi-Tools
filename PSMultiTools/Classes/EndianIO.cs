...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
    ...
    public class EndianReader(Stream Input, EndianType EndianType) : BinaryReader(Input)
    {
        ...
        public AnyBitmap ParseImage(int Size)
        {
            using var stream = new MemoryStream(base.ReadBytes(Size));
            var NewAnyBitmap = AnyBitmap.FromStream(stream);
            return NewAnyBitmap;
        }
    }
    ...
    public class EndianWriter(Stream Input, EndianType EndianType) : BinaryWriter(Input)
    {
        public EndianType EndianType = EndianType;
        ...
        public void Write(AnyBitmap Image)
        {
            using var ms = new MemoryStream();
            Image.ExportStream(ms, AnyBitmap.ImageFormat.RawFormat);
