...
Class MainWindow
    ...
    Private Sub HomeWindow_ContentRendered(sender As Object, e As EventArgs) Handles Me.ContentRendered
        'Title = String.Format("Multi Tools - v{0}.{1}.{2} - {3}", Application.Current..Version.Major, My.Application.Info.Version.Minor, My.Application.Info.Version.Build, Text.Encoding.ASCII.GetString(Utils.ByBytes))
    End Sub
